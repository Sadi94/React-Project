                                            ...
                                            <div className="row ">
                                                ...
                                                <div className="col-6">
                                                    ...
                                                    <div className="mb-4 d-flex justify-content-end">
                                                        {/* <button type="submit" className="registration-button font-weight-bold" href="http://127.0.0.1:8000/emailToVerify">Submit</button> */}
                                                        {/* <a href="http://127.0.0.1:8000/emailToVerify" type="submit" className="registration-button font-weight-bold"> Submit</a> */}
                                                        {/* <button onclick="location.href='{{ url('http://127.0.0.1:8000/emailToVerify') }}'">Submit</button> */}
